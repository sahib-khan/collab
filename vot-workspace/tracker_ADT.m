...
tracker_command = generate_python_command('ADT', {'/content/collab/tracker' , '/content/collab/vot-toolkit/native/trax/support/python'});

tracker_interpreter = 'python';

 tracker_linkpath = {'/content/collab/trax/bin', '/content/collab/trax/lib', '/content/collab/tracker/ADNet_params.mat'}; % A cell array of custom library directories used by the tracker executable (optional)
