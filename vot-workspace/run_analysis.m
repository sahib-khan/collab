...
addpath('/content/collab/vot-toolkit'); toolkit_path; % Make sure that VOT toolkit is in the path
...
workspace_analyze(trackers, sequences, experiments, 'report_ADT', 'Title', 'Report for vot2013');
